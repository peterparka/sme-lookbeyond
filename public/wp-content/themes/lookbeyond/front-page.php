...
<main role="main">
	...
	<section class="bgg-c1 xpad-top z-top ">
		...
		<?php endif; ?>
			...
			<!-- <div class="col-12_sm-4 circle os-animation" data-os-animation="fadeInUp" data-os-animation-delay=".3s">
				<div class="circle__inner">
					<div class="circle__wrapper">
						<div class="circle__content">
							<img src="<?php echo get_template_directory_uri(); ?>/_img/bike.svg" alt="">
							<h5>Powering your play</h5>
						</div>
					</div>
				</div>
			</div>

			<div class="col-12_sm-4 circle os-animation" data-os-animation="fadeInUp" data-os-animation-delay=".6s">
				<div class="circle__inner">
					<div class="circle__wrapper">
						<div class="circle__content">
							<img src="<?php echo get_template_directory_uri(); ?>/_img/floatie.svg" alt="">
							<h5>Providing Safety</h5>
						</div>
					</div>
				</div>
			</div> -->
	...
	<section class="bg-white xpad-top">
		...
		<header class="row text-block os-animation" data-os-animation="fadeInUp">
			...
			<!-- <p>They’re surprising. They’re thought-provoking. They’ve got everything to do with your life.</p> -->
		</header>
